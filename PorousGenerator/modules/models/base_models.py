...
class Generator(Model):
    def __init__(self, inputs, start_img_shape=(8,8,8,1), outputs = None, **kwargs):
...
class Discriminator(Model):
    ...
    def __build(self, img_shape:tuple):
        ...
        if batch_size != None:
            ...
            input_img = Input(batch_shape=batch_shape, name='input_img')#(batch_size,8,8,8,1))#img_shape)
        else:
